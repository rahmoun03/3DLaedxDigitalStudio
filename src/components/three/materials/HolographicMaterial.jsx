...
const HolographicShaderMaterial  = shaderMaterial(
	...
	void main() {
		...
		vec4 baseColor = vec4(hologramColor, mix(hologramBrightness, vUv.y, 0.5));
		...
		baseColor += vec4(r*scanlines, b*scanlines, r, 1.0) / 84.;
		vec4 scanlineMix = mix(vec4(0.0), baseColor, baseColor.a);
		...
		// If alphaMap exists, sample it and multiply with base alpha
		#ifdef USE_ALPHAMAP
